...
```mermaid
flowchart TD
    Step1[開發夥伴本地環境 - 開發/單元測試/打包]
    Step2[GitHub - PR 至 develop]
    Step3[測試環境 - 業務與資訊承辦人驗收]
    Step4[GitHub - 合併至 main]
    Step5[正式環境]

    Step1 -->|提交 dist 交付檔案| Step2
    Step2 -->|CI/CD 自動觸發部署| Step3
    Step3 -->|驗收通過| Step4
    Step4 -->|CI/CD 自動觸發部署| Step5
```
